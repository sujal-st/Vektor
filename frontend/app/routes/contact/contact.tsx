      ...
      <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-[#F6F1E6] px-6 py-8 rounded-md">
          ...
          <p className="mt-4 text-[#3C3C3C] text-lg leading-8">
            Have a question about a product, need help choosing parts for your build,
            or want to track an existing order? Our tech team is ready to help —
          ...
          <div className="mt-10 space-y-6">
            <div className="flex items-start gap-3">
              ...
              <p>Unit 4B, TechHub Building <br /> Gilmore Ave, Quezon City, PH 1100</p>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <p>support@shopifyph.com</p>
            </div>
          </div>

          {/* Store Hours */}
          <div className="mt-10 border-t border-gray-300 pt-6">
            <h3 className="font-semibold text-[#262626] text-lg mb-3">Store Hours</h3>
          ...
          <div className="mt-8 border-t border-gray-300 pt-6">
            <h3 className="font-semibold text-[#262626] text-lg mb-3">Quick Support</h3>
            <div className="flex flex-wrap gap-2">
              {["Track My Order", "Return & Warranty", "Build Consultation", "Bulk / Corporate Orders"].map((tag) => (
                <span
                  key={tag}
        ...
        <div className="bg-[#F6F1E6] px-6 py-8 rounded-md relative">
          ...
          <h2 className="text-2xl font-semibold text-[#262626] mb-1">Send us a message</h2>
          <p className="text-sm text-[#3C3C3C] mb-6">Need a part recommendation or build quote? Drop us a message below.</p>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  name="message"
                  rows={4}
                  placeholder="Tell us about your build goals, the parts you need, or your order details..."
                  className="mt-2.5 block w-full rounded-md bg-[#1E6D72]/15 px-3.5 py-2 text-[#262626] placeholder-[#1E6D72] focus:outline-2 focus:outline-[#AB2320]"
                />
              </div>
