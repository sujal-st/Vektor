...
function Product({ product }: PropType) {
    ...
    return (
        <Link to={`/products/${product.id}`} className='min-w-20 p-5 min-h-50 bg-white rounded-sm shadow-sm flex flex-col justify-between gap-5 hover:scale-101 transition duration-200'>

            <div className='min-w-20 p-5 min-h-50 bg-white rounded-sm shadow-sm flex flex-col justify-between gap-5 hover:scale-101 transition duration-200'>
                ...
                <div className='flex flex-col space-y-5'>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <span>{product.wilson_score?.toFixed(3)}</span>
                    </div>
